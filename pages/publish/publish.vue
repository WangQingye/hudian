<template>
	...
	<!-- 		<u-form-item label="任务分类" prop="type">
			...
			<u-form-item label="生活标题" prop="link">
				<u-input v-model="form.link" placeholder="为生活取个标题吧" />
			</u-form-item>
			<u-form-item label="生活图片" prop="img">
				...
				<text style="color: #D3D3D3;">记录今日美好的图片</text>
			</u-form-item>
			<u-form-item label="生活描述" prop="desc">
				<u-input v-model="form.desc" type="textarea" placeholder="今天有哪些记得记住的事情" />
			</u-form-item>
